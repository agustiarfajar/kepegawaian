        ...
        <section class="section">
            <div class="card">
                ...
                ?>
                    ...
                    <form action="lembur-hapus.php" method="POST">
                        <div class="row">
                            <div class="col">
                        ...
                        <button type="submit" class="btn btn-primary" name="btnHapus" onclick="return confirm('Apakah anda yakin ingin menghapus data?')"><i class="fas fa-edit"></i> Delete </button>
