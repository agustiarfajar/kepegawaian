        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Form Hapus Pengguna Sistem</h3>
                </div>
    ...
    <section class="section">
            <div class="card">          
                ...
                <div class="card-body">
                    ...
                    ?>
                    <form action="pengguna-hapus.php" method="post">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" name="nama" maxlength="50" value="<?php echo $datauser["nama"] ?>" class="form-control" placeholder="Masukan Nama" id="nama" autocomplete="off" readonly>
                                        <div class="form-control-icon">
                                ...
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" name="no_telp" maxlength="13" value="<?php echo $datauser["no_telp"] ?>" class="form-control" placeholder="Masukan No.Telp" id="no_telp" autocomplete="off" readonly>
                                        <div class="form-control-icon">
                                ...
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" name="username" maxlength="20" value="<?php echo $datauser["username"] ?>" class="form-control" placeholder="Masukan Username" id="username" autocomplete="off" readonly>
                                        <div class="form-control-icon">
                                            <i class="bi bi-person"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" name="level" value="<?php echo ($datauser["level"]==1?"Direktur":($datauser["level"]==2?"Administrator":"")) ?>" class="form-control" autocomplete="off" readonly>
                                        <div class="form-control-icon">
                                            <i class="bi bi-person"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="button" onclick="konfirmasiHapus()" name="btnUpdate" class="btn btn-danger me-1 mb-1">Hapus</button>
